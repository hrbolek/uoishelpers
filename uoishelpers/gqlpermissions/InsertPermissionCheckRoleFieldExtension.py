...
import functools
T = typing.TypeVar("T")
class InsertPermissionCheckRoleFieldExtension(UpdatePermissionCheckRoleFieldExtension, typing.Generic[T]):
    ...
    def return_error(self, info: strawberry.types.Info, message: str, code: str, input_data: typing.Any = None):
        ...
        return InsertError[self.GQLModel](**error_description)
